...
// TTPLAPIManager
#define COCOAPODS_POD_AVAILABLE_TTPLAPIManager
#define COCOAPODS_VERSION_MAJOR_TTPLAPIManager 0
#define COCOAPODS_VERSION_MINOR_TTPLAPIManager 1
#define COCOAPODS_VERSION_PATCH_TTPLAPIManager 0
