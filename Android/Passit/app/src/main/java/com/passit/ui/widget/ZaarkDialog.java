    ...
    private ZaarkDialog(Builder builder) {
        ...
        if (mBuilder.positiveText == null && mBuilder.negativeText == null) {
            ...
            if (mBuilder.positiveText != null) {
                ...
                TextView positiveTextView = (TextView) ((FrameLayout) mPositiveButton).getChildAt(0);
                positiveTextView.setText(mBuilder.positiveText);
                positiveTextView.setTextColor(getActionTextStateList(R.color.primary_color));
            ...
            if (mBuilder.negativeText != null) {
                TextView negativeTextView = (TextView) ((FrameLayout) mNegativeButton).getChildAt(0);

                negativeTextView.setText(mBuilder.negativeText);
                negativeTextView.setTextColor(getActionTextStateList(R.color.primary_color));
